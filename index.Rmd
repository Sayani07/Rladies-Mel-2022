...
show layer_data for different geoms
...
#  From plot specification to plot image

.pull-left[
```{r plot-spec, echo = TRUE, eval = FALSE}
p <- ggplot(mpg, 
            aes(displ, hwy, 
                color = drv)) +
...
```{r plot-image, echo = FALSE, eval = TRUE}
...
- Wait for experienced developers to host webinars, release official guides before developing ggplot2 extensions OR make a modest start?  


This is me making a modest attempt.
...
# Examples: Same geom different inputs
...
# Extending ggplot2: Action plan?

- HDR is a novel technique for summarizing distribution for which plotting is not implemented in ggplot2

- Sometimes complete story is told my multiple plots and `hdrcde` does not allow for 
extensive flexibility and customization of plots

- hdr.boxplot() looks close to geom_boxplot(). Compare to answer what your new stat and geom functions should be able to answer

---

# geom_boxplot() vs. hdr.boxplot()
