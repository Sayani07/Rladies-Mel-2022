...
#  Action plan?
 ...
 - If your desired geom looks similar to an existing geom, start from there.
 .smaller[

  - hdr.boxplot() looks similar to geom_boxplot()
  - geom_hdr_rug() looks like a combination of geom_rect() and geom_segment()
       ]
...
# Let's go: geom_boxplot() vs. hdr.boxplot()
